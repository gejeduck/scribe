defmodule SocialScribeWeb.ModalComponents do
  ...
  @doc """
  Renders a CRM update modal wrapper.

  Used for HubSpot, Salesforce, and other CRM contact update flows.
  ...
  ## Examples
      ...
      <.crm_modal id="crm-modal-wrapper" show on_cancel={JS.patch(~p"/back")}>
        Modal content here
      </.crm_modal>
  """
